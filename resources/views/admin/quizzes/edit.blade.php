                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <form action="{{ route('admin.quizzes.update', $quiz) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="description" id="description" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">{{ old('description', $quiz->description) }}</textarea>
                            @error('description')
                                <p class="text-red-500 text-xs italic">{{ $message }}</p>
                            @enderror
                        </div>
